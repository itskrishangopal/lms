...
<br>
    ...
    <h1 style="text-align: center; padding-top: 40px; font-family: sans-serif;"><strong>View Issued Books</strong></h1>
    <br>
  <div style="padding-left: 20px; padding-right: 20px;">
    <table class="table table-bordered border-dark">
      <tr class="table-primary">
        <th scope="col"><center>Issued to</th></center>
        <th scope="col"><center>Book Name</th></center>
        <th scope="col"><center>Author Name</th></center>
        <th scope="col"><center>Year of Publish</th></center>
        <th scope="col"><center>Time</th></center>
      </tr>
...
<?php
  ...
  //$sql = "SELECT issueto,bid,bname,bauthor,yop,Time FROM viewissuedbooks";
  ...
  $result = $conn->query($sql);
   ...
   if($result->num_rows > 0) {
     while($row = $result->fetch_assoc()) {
       echo "<tr><td><center><strong>". $row["issueto"] ."</strong></center></td><td><center>". $row["bname"] ."</center></td><td><center>". $row["bauthor"] ."</center></td><td><center>". $row["yop"] ."</center></td><td><center>". $row["Time"] ."</center></td></tr>";
      }
      echo "</table>";
    }
    else {
...
?>
  ...
  <center><a href="exceladminviewissuedbook.php">
