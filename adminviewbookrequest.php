...
<br>
<br>
    <h1 style="text-align: center; padding-top: 40px; font-family: sans-serif;"><strong>View Book Requests</strong></h1>
    <br>  
  ...
  $result = $conn->query($sql);
   ...
   if($result->num_rows > 0) {
     while($row = $result->fetch_assoc()) {
       echo "<tr><td><center>". $row["rbid"] ."</center></td><td><center>". $row["rbname"] ."</center></td><td><center>". $row["rbauthor"] ."</center></td><td><center>". $row["ryop"] ."</center></td><td><center>". $row["Time"] ."</center></td><td><center><a href='deleteadminviewbookrequest.php?rn=$row[rbid]''><button>Delete</button></a></center></td></tr>";
      }
      echo "</table>";
    }
    else {
...
?>
  ...
  <center><a href="exceladminviewbookrequest.php">
