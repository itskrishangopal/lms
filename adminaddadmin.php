...
if(isset($_POST['ausername'])) {
	...
	$query = "SELECT * FROM admindetails WHERE ausername='$ausername'";
    ...
    echo '<script>alert("Username already exist")</script>';
		...
		$sql = "INSERT INTO admindetails (aname,ausername,apassword) VALUES ('$aname','$ausername','$apassword')";
...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <h1 style="text-align: center; padding-top: 40px; font-family: sans-serif;"><strong>Add New Admin</strong></h1>
        ...
        <div class="col-md-4" style="padding-top: 50px;">
              <form method="POST" action="#">
                ...
                <div style="padding-right: 10px;">
                  <center><button type="submit" class="btn btn-success">Add Admin</button></center>
                </div>
            </form>
          </div>
    </div>
